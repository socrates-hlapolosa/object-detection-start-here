...
kubectl apply -f https://github.com/kubesphere/ks-installer/releases/download/v3.3.0/cluster-configuration.yaml --kubeconfig /Users/socrates/.kube/$1
...
kubectl logs -n kubesphere-system $(kubectl get pod --kubeconfig /Users/socrates/.kube/$1 -n kubesphere-system -l 'app in (ks-install, ks-installer)' -o jsonpath='{.items[0].metadata.name}') -f --kubeconfig /Users/socrates/.kube/$1
